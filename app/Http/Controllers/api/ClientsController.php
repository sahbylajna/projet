...
public function getnotife(){
    ...
    $exports = export::where('client_id',auth()->user()->id)->sortBy('created_at')->get();
    $importations = importation::where('client_id',auth()->user()->id)->sortBy('created_at')->get();
    $backs = back::where('client_id',auth()->user()->id)->sortBy('created_at')->get();
    $c = collect();


foreach ($exports as $key => $value) {
    $dd = acceptation_demande::where('demande_id', $value->id)->sortBy('created_at')->get();
    foreach($dd as $d){
