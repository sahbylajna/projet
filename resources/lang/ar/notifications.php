...
return [
    ...
    'demande' => 'Demande',
    'demande__placeholder' => 'Enter demande here...',
    'type' => 'Type',
    ...
    'index_route_description' => 'Retrieve existing notifications.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the notification property name where the value is the assigned value to the retrieved notification.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved notification.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of notifications per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved notification.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new notification.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing notification.',
    ...
    'show_route_description' => 'Retrieve existsing notification.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the notification to retrieve',
    'destroy_route_description' => 'Delete existsing notification.',
    ...
    'the_id_of_model_to_delete' => 'The id of the notification to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete notifications.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the notification.',
    ...
    'the_requested_model_does_not_exists' => 'The requested notification does not exists.',
    ...
    'none_available' => 'No Notifications Available.',
    ...
    'model_id_camel_case' => 'notificationId',
