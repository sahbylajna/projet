...
return [
    ...
    'Username' => 'Username',
    'Username__placeholder' => 'Enter username here...',
    'Password' => 'Password',
    'Password__placeholder' => 'Enter password here...',
    'access_token' => 'Access Token',
    'access_token__placeholder' => 'Enter access token here...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing api users.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the api user property name where the value is the assigned value to the retrieved api user.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved api user.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of api users per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved api user.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new api user.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing api user.',
    ...
    'show_route_description' => 'Retrieve existsing api user.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the api user to retrieve',
    'destroy_route_description' => 'Delete existsing api user.',
    ...
    'the_id_of_model_to_delete' => 'The id of the api user to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete api users.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the api user.',
    ...
    'the_requested_model_does_not_exists' => 'The requested api user does not exists.',
    ...
    'create' => 'Create New Api User',
    'delete' => 'Delete Api User',
    'edit' => 'Edit Api User',
    'show' => 'Show Api User',
    'show_all' => 'Show All Api User',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Api User.',
    'none_available' => 'No Api Users Available.',
    'model_plural' => 'مستخدمي API',
    'model_was_added' => 'Api User was successfully added.',
    'model_was_retrieved' => 'Api User was successfully retrieved.',
    'models_were_retrieved' => 'Api Users were successfully retrieved.',
    'model_was_updated' => 'Api User was successfully updated.',
    'model_was_deleted' => 'Api User was successfully deleted.',
    ...
    'model_id_camel_case' => 'api userId',
