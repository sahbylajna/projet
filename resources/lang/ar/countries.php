...
return [
    ...
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the countries property name where the value is the assigned value to the retrieved countries.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved countries.',
    ...
    'show_route_description' => 'Retrieve existsing countries.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the countries to retrieve',
    'destroy_route_description' => 'Delete existsing countries.',
    ...
    'the_id_of_model_to_delete' => 'The id of the countries to delete.',
    ...
    'the_id_of_the_model' => 'The id of the countries.',
    ...
    'the_requested_model_does_not_exists' => 'The requested countries does not exists.',
