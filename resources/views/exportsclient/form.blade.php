...
<div class="form-group {{ $errors->has('SHIPPING_DATE') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="SHIPPING_DATE" type="date" id="SHIPPING_DATE" value="{{ old('SHIPPING_DATE', optional($export)->SHIPPING_DATE) }}" placeholder="{{ trans('importations.SHIPPING_DATE__placeholder') }}">
...
<div class="form-group {{ $errors->has('EXP_PASSPORT_NUM') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="Pledge" type="file" id="Pledge" value="{{ old('Pledge', optional($export)->Pledge) }}" minlength="1" placeholder="{{ trans('importations.files') }}">
        {!! $errors->first('EXP_PASSPORT_NUM', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
{{-- <div class="form-group {{ $errors->has('EXP_PASSPORT_NUM') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="animal" type="number" id="animal" value="{{ old('animal', optional($export)->animal) }}" minlength="1" placeholder="">
        {!! $errors->first('EXP_PASSPORT_NUM', '<p class="help-block">:message</p>') !!}
    </div>
</div> --}}
