...
<img src="{{ asset('images/pdf1.png') }}" alt="" style="   float: left!important;">
    ...
    <br style="    -webkit-box-sizing: border-box!important;">
    <br style="    -webkit-box-sizing: border-box!important;">
        <p style="text-align:center;"><u>تعهد</u> </p>
        <p style="text-align:center;"><u>( المشاركين  بفعاليات  لجنة سباق الهجن )</u> </p>


    <p>
        <br style="    -webkit-box-sizing: border-box!important;">

        <p style="  ">بعدم مطالبة وزارة البلدية و البيئة باحداثية او ترقيم  حلال اللا في حالة وجود موقع مرخص ،
            و هذا تعهد مني بذلك</p>
