...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($countries->name) ? $countries->name : 'Countries' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('countries.countries.update', $countries->id) }}" id="edit_countries_form" name="edit_countries_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
