...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('clients.client.update', $client->id) }}" enctype="multipart/form-data"   id="edit_client_form" name="edit_client_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
...
<div class="form-group {{ $errors->has('photo_ud_frent') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input  class="form-control" name="photo_ud_frent" type="file" id="photo_ud_frent"  minlength="1" placeholder="{{ trans('clients.photo_ud_frent__placeholder') }}">
...
<div class="form-group {{ $errors->has('photo_ud_back') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input  class="form-control" name="photo_ud_back" type="file" id="photo_ud_back"  minlength="1" placeholder="{{ trans('clients.photo_ud_back__placeholder') }}">
...
<div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input  class="form-control" name="password" type="password" id="password" placeholder="{{ trans('clients.password__placeholder') }}">
