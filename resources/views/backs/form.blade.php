...
<div class="form-group {{ $errors->has('client_id') ? 'has-error' : '' }}">
    <label for="client_id" class="col-md-2 control-label">{{ trans('backs.client_id') }}</label>
    <div class="col-md-10">
        <select class="form-control" id="client_id" name="client_id">
        	    <option value="" style="display: none;" {{ old('client_id', optional($back)->client_id ?: '') == '' ? 'selected' : '' }} disabled selected>{{ trans('backs.client_id__placeholder') }}</option>
        	@foreach ($clients as $key => $client)
			    <option value="{{ $key }}" {{ old('client_id', optional($back)->client_id) == $key ? 'selected' : '' }}>
			    	{{ $client }}
			    </option>
			@endforeach
        </select>
...
<div class="form-group {{ $errors->has('COMP_ID') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <select class="form-control" id="COMP_ID" name="COMP_ID">
        	    <option value="" style="display: none;" {{ old('COMP_ID', optional($back)->COMP_ID ?: '') == '' ? 'selected' : '' }} disabled selected>{{ trans('backs.COMP_ID__placeholder') }}</option>
        	@foreach ($cOMPs as $key => $cOMP)
			    <option value="{{ $key }}" {{ old('COMP_ID', optional($back)->COMP_ID) == $key ? 'selected' : '' }}>
			    	{{ $cOMP }}
			    </option>
			@endforeach
        </select>
...
<div class="form-group {{ $errors->has('EXP_COUNTRY') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="EXP_COUNTRY" type="number" id="EXP_COUNTRY" value="{{ old('EXP_COUNTRY', optional($back)->EXP_COUNTRY) }}" placeholder="{{ trans('backs.EXP_COUNTRY__placeholder') }}">
...
<div class="form-group {{ $errors->has('IMP_COUNTRY') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="IMP_COUNTRY" type="number" id="IMP_COUNTRY" value="{{ old('IMP_COUNTRY', optional($back)->IMP_COUNTRY) }}" placeholder="{{ trans('backs.IMP_COUNTRY__placeholder') }}">
...
<div class="form-group {{ $errors->has('ORIGIN_COUNTRY') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="ORIGIN_COUNTRY" type="number" id="ORIGIN_COUNTRY" value="{{ old('ORIGIN_COUNTRY', optional($back)->ORIGIN_COUNTRY) }}" placeholder="{{ trans('backs.ORIGIN_COUNTRY__placeholder') }}">
